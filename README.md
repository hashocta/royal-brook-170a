...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/royal-brook-170a
```

A live public deployment of this template is available at [https://royal-brook-170a.templates.workers.dev](https://royal-brook-170a.templates.workers.dev)
